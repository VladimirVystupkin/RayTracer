...
public class Solvers {
    ...
    public static double[] solveQuadric(final double a, final double b, final double c) {
    ...
    private static double solveCubicForQuartic(final double p, final double q, final double r) {
        double A2 = p * p;
