...
public final class Solvers {
    ...
    public static double[] solveQuartic(double a, double b, double c, double d, double e, double x) {
        double inva = 1 / a;
        double c1 = b * inva;
        double c2 = c * inva;
        double c3 = d * inva;
    ...
    private static final double solveCubicForQuartic(double p, double q, double r) {
        ...
        if (d >= 0) {
            ...
            if (R < 0) {
                double root = (sQ + Q / sQ) - an;
                double dif =getDif(p,q,r,root);
                return (sQ + Q / sQ) - an;
            } else
                return -(sQ + Q / sQ) - an;
        }
    ...
    public static  double getDif(double p, double q, double r,double z){
        return z*z*z+p/2*z*z+(p*p-4*r)/16*z-q*q/64;
    }
}
